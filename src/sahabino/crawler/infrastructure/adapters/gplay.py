...
class GPlayScraperAdapter:
    ...
    def _extract_review_item(self, item: Any) -> ReviewRecord:
        raw: dict[str, Any] = {}
...
def decode_gplay_review_response(response: str) -> list[list[Any]]:
    ...
    if not isinstance(items, list):
        raise ParseFailure("gplay reviews parser returned an invalid page")
    return items
