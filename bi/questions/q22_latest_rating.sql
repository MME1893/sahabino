-- Latest reported raw rating by application and historical crawl locale; no rounded SQL values.
WITH observed AS (
 SELECT a.name AS application_name,a.package_name,ct.country_code AS crawl_country_code,
 ct.language_code AS crawl_language_code,s.score::numeric AS store_score_0_to_5,s.collected_at,
...
SELECT application_name,package_name,crawl_country_code,crawl_language_code,store_score_0_to_5,collected_at AS latest_collected_at
